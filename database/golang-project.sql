...
VALUES
    ('Ederson', NULL, 29, 80000000, 'Goalkeeper', 1),
    ...
    ('Rodri', NULL, 25, 70000000, 'Midfielder', 1),
...
VALUES
    ...
    ('Casemiro', NULL, 30, 80000000, 'Midfielder', 2),
...
INSERT INTO Player (first_name, last_name, player_age, player_cost, player_pos, team_id)
VALUES
    ('Alisson', NULL, 29, 80000000, 'Goalkeeper', 3),
    ...
    ('Fabinho', NULL, 28, 60000000, 'Midfielder', 3),
...
VALUES
    ...
    ('Pedri', NULL, 19, 80000000, 'Midfielder', 4),
...
VALUES
    ...
    ('Marquinhos', NULL, 28, 80000000, 'Defender', 8),
...
VALUES
    ...
    ('Arthur', NULL, 26, 50000000, 'Midfielder', 9),
...
VALUES
    ...
    ('Koke', NULL, 30, 45000000, 'Midfielder', 13),
